...
export default function FloatingCTA() {
  ...
  return (
    <>
      ...
      <a
        href={`https://wa.me/${whatsappNumber}?text=Hi, I want to rent a scooty/bike in Varanasi`}
        target="_blank"
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-dark-200 p-4 z-40 shadow-2xl">
        <div className="flex gap-2">
          ...
          <a
            href="/contact"
            className="flex-1 bg-primary-500 text-white py-3 px-4 rounded-lg font-semibold text-center hover:bg-primary-600 transition-colors"
          >
            Book Now
          </a>
        </div>
